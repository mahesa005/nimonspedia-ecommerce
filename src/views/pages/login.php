<div class="auth-content">
  ...
  <form class="forms-container" action="/login" method="POST">
    <div class="forms">
      ...
      <input type="email" id="email" name="email" placeholder="nimons@gro.com" required>
    </div>
    <div class="forms password-wrapper">
      ...
      <svg class="eye-icon eye-closed" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
