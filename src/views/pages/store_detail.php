...
<div class="container">
    ...
    <div class="main-content" data-store-id="<?php echo $store->store_id; ?>">
        <div class="store-info-header">
            <div class="store-info-logo">
                <img src="<?php echo htmlspecialchars($store->getLogoPath()); ?>" alt="Logo <?php echo htmlspecialchars($store->store_name); ?>">
            </div>
            <div class="store-info-details">
                <h1 class="store-info-name"><?php echo htmlspecialchars($store->store_name); ?></h1>
                <div class="store-info-description">
                    <?php 
                        echo nl2br($store->store_description ?? 'Toko ini belum memiliki deskripsi.');
                    ?>
                </div>
            </div>
        </div>
